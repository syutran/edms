...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { branchname: @branch.branchname, coding: @branch.coding, parent_id: @branch.parent_id, status: @branch.status }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { branchname: @branch.branchname, coding: @branch.coding, parent_id: @branch.parent_id, status: @branch.status }
    assert_redirected_to branch_path(assigns(:branch))
  end
